      ...
      <div className="flex-1 max-w-screen-2xl mx-auto w-full px-6 sm:px-12 lg:px-20 py-8 sm:py-12 space-y-8">
        ...
        <header className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-100">Test del Prompt</h2>
              <p className="text-slate-400 text-base sm:text-lg lg:text-xl mt-2">Risultato dell'esecuzione del tuo prompt C.R.A.F.T.</p>
            </div>
          </div>
        </header>
        ...
        <section className="bg-slate-800/50 border border-slate-700 p-6 sm:p-8 rounded-2xl shadow-lg">
          <h3 className="text-xl sm:text-2xl font-semibold text-emerald-400 mb-5">Prompt in Test</h3>
          <div className="bg-slate-900/50 p-4 sm:p-5 rounded-lg whitespace-pre-wrap text-slate-300 font-mono text-sm sm:text-base max-h-60 overflow-y-auto">
        ...
        <section className="flex flex-wrap gap-4">
          <button
            ...
            className="flex items-center gap-2 sm:gap-3 bg-green-600 hover:bg-green-500 text-white font-bold py-3 px-5 rounded-lg transition-colors disabled:bg-slate-600 disabled:cursor-not-allowed text-sm sm:text-base"
          >
            {isTesting ? (
              <>
                <div className="w-5 h-5 sm:w-6 sm:h-6 border-2 border-t-white border-slate-400 rounded-full animate-spin"></div>
          ...
          {testResult && (
            <button
              ...
              className="flex items-center gap-2 sm:gap-3 bg-slate-600 hover:bg-slate-500 text-white font-bold py-3 px-5 rounded-lg transition-colors text-sm sm:text-base"
            >
              {copied ? <CheckIcon className="w-5 h-5 sm:w-6 sm:h-6 text-green-400" /> : <ClipboardIcon className="w-5 h-5 sm:w-6 sm:h-6" />}
         ...
         {(isTesting || testResult) && (
           <section className="bg-slate-800/50 border border-slate-700 p-6 sm:p-8 rounded-2xl shadow-lg">
             <div className="flex items-center justify-between mb-5">
               <h3 className="text-xl sm:text-2xl font-semibold text-fuchsia-400">Risultato del Test</h3>
               <span className="text-sm sm:text-base text-slate-400 bg-slate-700 px-3 py-1.5 rounded">Max Output: 8192 tokens</span>
             </div>

            {isTesting && !testResult && (
              <div className="flex items-center text-slate-400 text-base sm:text-lg">
                <div className="w-6 h-6 border-2 border-t-fuchsia-400 border-slate-500 rounded-full animate-spin mr-3"></div>
             ...
             {testResult && (
               <div className="prose prose-base md:prose-lg prose-invert max-w-none">
                 {isTruncated && (
                   <div className="bg-amber-900/30 border border-amber-600 text-amber-200 p-4 rounded-lg mb-5 text-sm sm:text-base">
                 ...
                 <div className="bg-slate-900/50 p-4 sm:p-5 rounded-lg whitespace-pre-wrap text-slate-300 text-sm sm:text-base">
                   {testResult}
                 </div>
               </div>
             )}
        ...
        {/* Tips Section */}
        <section className="bg-slate-800/30 border border-slate-700 p-6 sm:p-8 rounded-2xl">
          <h3 className="text-xl sm:text-2xl font-semibold text-sky-400 mb-4">Consigli per il Test</h3>
